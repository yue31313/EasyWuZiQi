...
public class GameMainActivity extends GameBaseActivity implements
		OnClickListener {
	private Button startGameButon, degreeButton, helpButton,exitButton;
	...
	private void initView() {
		...
		degreeButton = (Button) findViewById(R.id.degree_game_button);
		degreeButton.setOnClickListener(this);
		helpButton = (Button) findViewById(R.id.help_game_button);
	...
	public void onClick(View v) {
		...
		case R.id.start_game_button:
			...
			activityEnterAnim();
			break;
		case R.id.degree_game_button:
			creatDialog(DEGREE_DIALOG);
			break;
		case R.id.help_game_button:
			gameIntent = new Intent(this, GameHelpActivity.class);
			this.startActivity(gameIntent);
			activityEnterAnim();
			break;
